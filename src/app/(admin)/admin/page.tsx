...
import { UpcomingSessionsWidget, RecentInscriptionsWidget } from "@/components/admin/dashboard";
  ...
  return (
    <div className="space-y-4 sm:space-y-6 min-w-0">
      ...
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-2 min-w-0">
        ...
        {/* Recent Inscriptions Widget */}
        <RecentInscriptionsWidget
          inscriptions={dashboardData?.recentInscriptions}
          isLoading={dashboardLoading}
        />
      </div>
